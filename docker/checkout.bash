...
if [[ "$BRANCH" = "develop" ]]; then
      git clone --depth=1 https://github.com/ucla-mobility/carma-msgs.git --branch  $BRANCH
      # git clone --depth=1 https://github.com/usdot-fhwa-stol/carma-msgs.git --branch  $BRANCH
      git clone --depth=1 https://github.com/usdot-fhwa-stol/carma-utils.git --branch $BRANCH
      git clone --depth=1 https://github.com/usdot-fhwa-stol/carma-messenger.git --branch $BRANCH
else
      git clone --depth=1 https://github.com/ucla-mobility/carma-msgs.git --branch feature/pull_over_integration
      ...
      git clone --depth=1 https://github.com/usdot-fhwa-stol/carma-messenger.git --branch carma-system-4.2.0
fi
